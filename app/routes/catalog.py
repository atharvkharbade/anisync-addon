        ...
        try:
            ...
            for item in paged_items:
                ...
                if is_new_ep and poster:
                    ...
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{m_id_for_url}_{short_tracker_str}_22.jpg?url={encoded_url}&badge=new&tracker={trackers_param}&style={badge_style}&v=newep_graphical_24"
        ...
        try:
            ...
            for item in paged_data_items:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "modern")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/simkl_{simkl_id}_s_22.jpg?url={encoded_url}&badge=new&tracker=simkl&style={badge_style}&v=newep_graphical_24"
        ...
        try:
            ...
            for item in paged_data_items:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "modern")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{mal_id}_m_22.jpg?url={encoded_url}&badge=new&tracker=mal&style={badge_style}&v=newep_graphical_24"
        ...
        try:
            ...
            for entry in paged_entries:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "modern")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{al_id}_a_22.jpg?url={encoded_url}&badge=new&tracker=anilist&style={badge_style}&v=newep_graphical_24"
