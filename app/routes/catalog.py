        ...
        try:
            ...
            for item in paged_items:
                ...
                if is_new_ep and poster:
                    ...
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{m_id_for_url}_{tracker_str}_v17.jpg?url={encoded_url}&badge=new&tracker={trackers_param}&style={badge_style}&v=newep_graphical_v17"
        ...
        try:
            ...
            for item in paged_data_items:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "classic")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/simkl_{simkl_id}_simkl_v17.jpg?url={encoded_url}&badge=new&tracker=simkl&style={badge_style}&v=newep_graphical_v17"
        ...
        try:
            ...
            for item in paged_data_items:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "classic")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{mal_id}_mal_v17.jpg?url={encoded_url}&badge=new&tracker=mal&style={badge_style}&v=newep_graphical_v17"
        ...
        try:
            ...
            for entry in paged_entries:
                ...
                if is_new_ep and poster:
                    encoded_url = urllib.parse.quote_plus(poster)
                    badge_style = user.get("badge_style", "classic")
                    poster = f"{Config.PROTOCOL}://{Config.REDIRECT_URL}/{user_id}/poster/{al_id}_anilist_v17.jpg?url={encoded_url}&badge=new&tracker=anilist&style={badge_style}&v=newep_graphical_v17"
